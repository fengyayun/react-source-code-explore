...
function shouldUpdate(classInstance,nextProps,nextState){
  ...
  if (nextProps) {
    classInstance.prevProps = classInstance.nextProps
...
export class PureComponent extends Component {
  shouldComponentUpdate(nextProps,nextState){
    let sameProp = shallowEqual(this.props,nextProps)
    let sameState = shallowEqual(this.state,nextState)
    console.log(sameProp,sameProp)
    return !sameProp || !sameState
  }
}
